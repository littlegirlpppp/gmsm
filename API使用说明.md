...
```bash
go get -u github.com/littlegirlpppp/tjfoc-gm
```

## SM3密码杂凑算法 - SM3 cryptographic hash algorithm
- 遵循的SM3标准号为： GM/T 0004-2012
- g package：`github.com/littlegirlpppp/tjfoc-gm/sm3`
...
- go package：`github.com/littlegirlpppp/tjfoc-gm/sm4`

### 代码示例

```Go
    import  "crypto/cipher"
    import  "github.com/littlegirlpppp/tjfoc-gm/sm4"
